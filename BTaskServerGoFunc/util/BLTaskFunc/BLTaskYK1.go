...
// 获取订单列表
func GetOrderListYK1(page int, list_rows int, status int) map[string]interface{} {
	resMap := make(map[string]interface{})

	ip := viper.GetString("平台ip.易客1")
	url := fmt.Sprintf("/api/supplier/order/v2/orders?page=%d&goodsSN=&orderSN=&state=%d&limit=%d", page, status, list_rows)

	AppID := viper.GetString("Ukey1.AppID")
	AppSecret := viper.GetString("Ukey1.AppSecret")
...
// 修改订单状态
func UpdateOrderStatusYK1(orderId int, oldStatus int, newStatus int) map[string]interface{} {
	resMap := make(map[string]interface{})
...
// 修改订单进度
func UpdateOrderScheduleYK1(orderId int, startNum int, currentNum int) map[string]interface{} {
	resMap := make(map[string]interface{})
...
// 获取播放订单列表
func GetBfOrderListYK1(page int, list_rows int, goods_id int) map[string]interface{} {
	resMap := make(map[string]interface{})
...
// 订单退款
func OrderrefundYK1(orderId int, oldStatus int, newStatus int, remark string, refund_number int) map[string]interface{} {
	resMap := make(map[string]interface{})
