...
type TaskList struct {
	...
	UStatus      int     `gorm:"index;column:UStatus;comment:订单状态 0处理中 1已完成 2退单 3播放任务完成并重置,4查询接口确定完成的" json:"UStatus" form:"UStatus"`
...
//
//// 领取播放任务出参
//type GetPalyTaskModel struct {
//	ID        int    `json:"id" form:"id"`
//	VideoLink string `json:"videoLink" form:"videoLink"`
//	GoodsName string `json:"goodsName" form:"goodsName"`
//	PlayCount int    `json:"playCount" form:"playCount"`
//}
//
//// 提交播放任务入参
//type SubmitPlayTaskQuery struct {
//	ID        int `json:"id" form:"id" binding:"required"`
//	PlayCount int `json:"playCount" form:"playCount" binding:"required"`
//}
