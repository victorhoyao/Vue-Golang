...
export default {
  ...
  'menu.user': '个人中心',
  'menu.user.info': '个人信息',
  'menu.yikeYile': '奕科易乐管理',
  'menu.yikeYile.management': '奕科易乐管理',
  'menu.taskItem': '任务项管理',
  'menu.taskItem.management': '任务项管理',
  'menu.taskDistribution': '任务分配',
  'menu.taskDistribution.management': '任务分配管理',
  'yikeYile.supplierId': '供应商ID',
  'yikeYile.supplierName': '供应商名称',
  'yikeYile.contact': '联系方式',
  'yikeYile.status': '状态',
  'yikeYile.tasksAssigned': '分配任务',
  'yikeYile.actions': '操作',
