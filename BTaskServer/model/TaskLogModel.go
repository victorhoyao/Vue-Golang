...
// 记录搜索入参
type FindTaskLogQuery struct {
	PageNum   *int   `json:"pageNum" form:"pageNum" binding:"required"`
	PageSize  *int   `json:"pageSize" form:"pageSize" binding:"required"`
	KsAccount string `json:"ksAccount" form:"ksAccount" binding:"required"`
	PreDate   string `json:"preDate" form:"preDate" binding:"required"`
	NextDate  string `json:"nextDate" form:"nextDate" binding:"required"`
}
